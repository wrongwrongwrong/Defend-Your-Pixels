...
export class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet("tok_mick_atk_a", "assets/sprites/old-mick-sprite.png", {
      frameWidth: 599, frameHeight: 1313,
    });
    this.load.image("tok_mick_atk_b", "assets/images/atk-mick-b.png");
    this.load.spritesheet("tok_mick_def", "assets/sprites/old-mick-sprite.png", {
  ...
  create() {
    const WHITE_BG_KEYS = [
      "tok_mick_atk_a", "tok_mick_atk_b", "tok_mick_nuke",
