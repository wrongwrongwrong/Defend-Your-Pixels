"""
websocket_server.py — Pixel Defense WebSocket Bridge
==========================================
...
Run:
    python bridge/websocket_server.py
...
async def camera_loop():
    ...
    if not cap.isOpened():
        ...
        print("  → Try changing CAMERA_ID at the top of bridge/websocket_server.py")
        return
