            ...
            <div class="help-popup__pane is-active" data-tab-pane="overview">
              ...
              <div class="help-popup__token-grid">
                <div class="help-popup__token-card">
                  ...
                  <div class="help-popup__token-desc">Blocks attacks until destroyed. Hard terrain takes 5 hits to clear.</div>
                </div>
                <div class="help-popup__token-card">
            ...
            <div class="help-popup__pane" data-tab-pane="tokens">
              ...
              <div class="help-popup__token-grid">
                <div class="help-popup__token-card">
                  ...
                  <div class="help-popup__token-desc">Each rifleman tracks kills separately. At 4 kills, that token randomly destroys 1 extra resource in a 3×3 area around its target. At 8 kills, it destroys 2 extra resources.</div>
                </div>
                <div class="help-popup__token-card">
                  ...
                  <div class="help-popup__token-desc">Each mob token tracks kills separately. At 4 kills, that token randomly destroys 1 extra resource in a 3×3 area around its target. At 8 kills, it destroys 2 extra resources.</div>
                </div>
              </div>
              ...
              <div class="help-popup__token-grid">
                <div class="help-popup__token-card">
                  ...
                  <div class="help-popup__token-side help-popup__farmer-col">Farmer side</div>
                  <div class="help-popup__token-desc">Every wheat paddock within his protection zone gains +1 HP, taking 2 hits instead of 1. When Old Mick's side drops to 12 remaining cells, that zone expands from 3×3 to 5×5.</div>
                </div>
                <div class="help-popup__token-card">
                  ...
                  <div class="help-popup__token-side help-popup__emu-col">Emu side</div>
                  <div class="help-popup__token-desc">Every feeding ground within its protection zone gains +1 HP, taking 2 hits instead of 1. When The Mob drops to 12 remaining cells, that zone expands from 3×3 to 5×5.</div>
                </div>
              </div>
              ...
              <div class="help-popup__token-grid">
                <div class="help-popup__token-card">
                  ...
                  <div class="help-popup__token-desc">Destructible heavy blocker. Takes 5 hits to destroy, then the lane opens.</div>
                </div>
                <div class="help-popup__token-card">
              ...
              <div class="help-popup__prose">ATK tokens aim in a <strong>straight line only</strong> — horizontal, vertical, or diagonal based on the token's facing. They hit the first valid enemy target in that lane. <strong>Hard terrain</strong> blocks until destroyed in 5 hits. <strong>Soft terrain</strong> blocks until destroyed in 2 hits.</div>
            </div>
              ...
              <div class="help-popup__upgrade-table">
                <div class="help-popup__upgrade-row">
                  ...
                  <div class="help-popup__upgrade-cell">
                    ...
                    <div class="help-popup__upgrade-desc">That specific rifleman token randomly destroys 1 extra feeding ground in the 3×3 area around its primary target.</div>
                  </div>
                  <div class="help-popup__upgrade-cell">
                    ...
                    <div class="help-popup__upgrade-desc">That specific mob token randomly destroys 1 extra wheat paddock in the 3×3 area around its primary target.</div>
                  </div>
                </div>
                ...
                <div class="help-popup__upgrade-row">
                  ...
                  <div class="help-popup__upgrade-cell">
                    ...
                    <div class="help-popup__upgrade-desc">Unlocked at 8 remaining Farmer cells. On P1's active turn, scan ID19 over enemy territory for a one-use 3×3 strike: all terrain is destroyed, and up to 5 resource cells are randomly destroyed. HQs are not hit.</div>
                  </div>
                  <div class="help-popup__upgrade-cell">
                    ...
                    <div class="help-popup__upgrade-desc">Unlocked at 8 remaining Mob cells. On P2's active turn, scan ID29 over enemy territory for a one-use 3×3 strike: all terrain is destroyed, and up to 5 resource cells are randomly destroyed. HQs are not hit.</div>
                  </div>
                </div>
              </div>
            </div>
