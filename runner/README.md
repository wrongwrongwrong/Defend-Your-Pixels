...
Entry points
- `run_live_tracker.py`: full live runtime for `camera -> python_tracker -> shared live rules -> websocket -> HTTP -> yu_test3/frontend/index.html`
...
- The live browser UI is served from `yu_test3/frontend/index.html` on `http://localhost:8080` by default.
